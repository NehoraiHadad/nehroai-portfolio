...
export const heDictionary: AppDictionary = {
  ...
  admin: {
    ...
    publicQuote: {
      ...
      reject: 'דחייה',
      approveConfirm: 'לאשר את הצעת המחיר? השולח יקבל הודעה.',
      rejectConfirm: 'לדחות את הצעת המחיר?',
      processing: 'מעבד…',
      pendingTitle: 'ממתין להחלטתך',
      pendingBody: 'עיין בהצעת המחיר למטה ואשר או דחה.',
      approvedTitle: 'הצעת המחיר אושרה',
      approvedBody: 'תודה — האישור נרשם.',
      rejectedTitle: 'הצעת המחיר נדחתה',
      rejectedBody: 'דחית את הצעת המחיר. השולח קיבל הודעה.',
      expiredTitle: 'תוקף הצעת המחיר פג',
      expiredBody: 'תאריך התוקף עבר. פנה לשולח לקבלת הצעה מעודכנת.',
      errorBody: 'משהו השתבש. רענן את הדף ונסה שוב.',
    },
  },
};
