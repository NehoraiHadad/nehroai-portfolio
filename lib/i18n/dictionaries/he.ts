...
export const heDictionary: AppDictionary = {
  ...
  admin: {
    ...
    clients: {
      ...
      cancel: 'ביטול',
      delete: 'מחיקה',
      deleteConfirm: 'האם למחוק את הלקוח? הצעות מחיר קיימות לא יושפעו.',
      created: 'הלקוח נוצר',
      updated: 'הלקוח עודכן',
      deleted: 'הלקוח נמחק',
      quoteHistory: 'הצעות מחיר',
      noQuotesForClient: 'אין עדיין הצעות מחיר מקושרות ללקוח זה.',
      quoteCount: 'הצעות',
      backToClients: 'חזרה ללקוחות',
      selectClient: 'בחר לקוח שמור',
      saveAsClient: 'שמור ללקוחות',
      noClients: 'אין עדיין לקוחות שמורים.',
    },
    quotes: {
      title: 'הצעות מחיר',
    ...
    settings: {
      ...
      tokens: {
        heading: 'טוקנים לסוכנים',
        description: 'טוקני Bearer המאפשרים לסוכני AI להזדהות מול ה-API ושרת ה-MCP. יש לשמור עליהם כסיסמאות.',
        labelPlaceholder: 'תווית לטוקן (אופציונלי)',
        createButton: 'יצירת טוקן',
        revealWarning: 'זו הפעם היחידה שתראה את הטוקן הזה — העתק אותו עכשיו.',
        copyButton: 'העתק',
        copied: 'הועתק!',
        dismiss: 'סגור',
        revoke: 'בטל',
        ...
        emptyState: 'אין טוקנים עדיין. צור טוקן כדי לאפשר לסוכנים להזדהות.',
        createError: 'יצירת הטוקן נכשלה. נסה שוב.',
      },
    },
    status: {
      draft: 'טיוטה',
    ...
    actions: {
      ...
      delete: 'מחיקה',
      cancel: 'ביטול',
      shareLinkLabel: 'קישור אישור ציבורי',
      copyLink: 'העתק קישור',
      linkCopied: 'הועתק!',
      shareError: 'יצירת הקישור נכשלה. נסה שוב.',
      shareWhatsapp: 'שליחה בוואטסאפ',
      shareEmail: 'שליחה במייל',
      shareWhatsappText: 'היי, הנה הצעת המחיר. אפשר לעבור עליה ולאשר ישירות כאן: ',
      shareEmailSubject: 'הצעת מחיר {number}',
      shareEmailBody: 'היי,\n\nמצורפת הצעת המחיר. אפשר לעבור עליה ולאשר ישירות בקישור:\n',
    },
    publicQuote: {
      approve: 'אישור הצעת המחיר',
      reject: 'דחיית ההצעה',
      approveConfirm: 'לאשר את הצעת המחיר הזו?',
      rejectConfirm: 'לסמן שההצעה לא מתאימה?',
      processing: 'רגע…',
      pendingTitle: 'הצעת מחיר ממתינה לאישורך',
      pendingBody: 'עברו על הפרטים למטה, וכשתהיו מוכנים — אשרו כאן.',
      approvedTitle: 'ההצעה אושרה',
      approvedBody: 'תודה! האישור נרשם — נהיה בקשר להמשך.',
      rejectedTitle: 'ההצעה סומנה כלא מתאימה',
      rejectedBody: 'תודה על העדכון. תמיד אפשר לחזור אליי אם משהו ישתנה.',
      expiredTitle: 'תוקף ההצעה פג',
      expiredBody: 'תאריך התוקף עבר. אפשר לפנות אליי ואשמח לשלוח הצעה מעודכנת.',
      errorBody: 'משהו השתבש. נסו לרענן את הדף ולנסות שוב.',
      undecidedPrompt: 'שאלה לפני שמאשרים? אפשר לחזור אליי:',
    },
  },
};
