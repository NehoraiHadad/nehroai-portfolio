...
export const enDictionary: AppDictionary = {
  ...
  admin: {
    ...
    actions: {
      ...
      shareWhatsappText: "Hi, here's the quote. You can review and approve it directly here: ",
      shareEmailSubject: 'Quote {number}',
      shareEmailBody: 'Hi,\n\nHere is the quote. You can review and approve it directly at the link below:\n',
    },
    publicQuote: {
      approve: 'Approve quote',
      reject: 'Decline',
      approveConfirm: 'Approve this quote?',
      rejectConfirm: 'Mark this quote as declined?',
      processing: 'One moment…',
      pendingTitle: 'A quote awaiting your approval',
      pendingBody: "Review the details below, and approve here when you're ready.",
      approvedTitle: 'Quote approved',
      approvedBody: "Thank you! Your approval is recorded — we'll be in touch with next steps.",
      rejectedTitle: 'Quote declined',
      rejectedBody: "Thanks for letting me know. Feel free to reach out if anything changes.",
      expiredTitle: 'This quote has expired',
      expiredBody: "Its validity date has passed. Reach out and I'll gladly send an updated quote.",
      errorBody: 'Something went wrong. Please refresh and try again.',
      undecidedPrompt: 'A question before you approve? Reach me:',
    },
  },
};
