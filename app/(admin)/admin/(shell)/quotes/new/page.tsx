...
import { allocateQuoteNumber, listClients } from '@/lib/admin/db/queries';
...
export default async function NewQuotePage() {
  ...
  const [dict, number, savedClients] = await Promise.all([
  ...
  return (
    <>
      ...
      <QuoteBuilder initialQuote={initialQuote} isNew savedClients={savedClients} />
    </>
  );
}
